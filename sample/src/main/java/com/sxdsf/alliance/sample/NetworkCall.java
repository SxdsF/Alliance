 ...
 * @desc ${描述类实现的功能}
 */
public class NetworkCall<R> extends CallAdapter<com.sxdsf.alliance.Response> {

	private final RequestQueue mQueue;
	private final com.sxdsf.alliance.Request<R> mRequest;
	...
	public NetworkCall(RequestQueue queue, com.sxdsf.alliance.Request<R> request) {
		mQueue = queue;
		mRequest = request;
	}
